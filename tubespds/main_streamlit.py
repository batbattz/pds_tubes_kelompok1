...
@st.cache_data
def load_data():
    df = pd.read_csv("cleaning_geocoding/data_koordinat_ready.csv")
    df2 = pd.read_csv("cleaning_geocoding/data_final_priority.csv")
    geojson_data = load_geojson("Jabar_Kec_clean.json") 
